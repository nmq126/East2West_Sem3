    ...
    internal sealed class Configuration : DbMigrationsConfiguration<East2West.Data.DBContext>
    {
        ...
        protected override void Seed(East2West.Data.DBContext context)
        {
            ...
            context.Tours.AddOrUpdate(x => x.Id,
                ...
                //    Name = "HA LONG BAY ",
                //    Description = "Cat Ba Island is a giant green carpet containing many mysteries and attractions. Cat Ba deserves to be the 3rd biosphere reserve in Vietnam, now recognized by UNESCO as a world biosphere reserve. The total area of Cat Ba biosphere reserve is more than 26,000 ha, with 2 core zones (strict conservation and no human impact), 2 buffer zones (allowing limited economic development but combined with conservation) and 2 transition zones (economic development). Cat Ba Biosphere Reserve is an area full of tropical rainforests on limestone islands, mangroves, coral reefs, seaweed mats and especially cave systems. Cat Ba also has Cai Beo site belonging to Ha Long culture, people lived 6475-4200 years ago.",
                //    TourCategoryId = "TOURC_1",
                //    Detail = "Cat Ba Island is a giant green carpet containing many mysteries and attractions. Cat Ba deserves to be the 3rd biosphere reserve in Vietnam, now recognized by UNESCO as a world biosphere reserve. The total area of Cat Ba biosphere reserve is more than 26,000 ha, with 2 core zones (strict conservation and no human impact), 2 buffer zones (allowing limited economic development but combined with conservation) and 2 transition zones (economic development). Cat Ba Biosphere Reserve is an area full of tropical rainforests on limestone islands, mangroves, coral reefs, seaweed mats and especially cave systems. Cat Ba also has Cai Beo site belonging to Ha Long culture, people lived 6475-4200 years ago.",
                //    Thumbnail = "",
                //    Duration = 4,
                //    Rating = 4.5,
                //    Policy = "",
            ...
            context.TourDetails.AddOrUpdate(x => x.Id,
               ...
               new TourDetail() { Id = "TOURDT_2", Status = 1, TourId = "TOUR_2", DepartureDay = Convert.ToDateTime("2022-08-09T23:49:58+02:00"), AvailableSeat = 20, Price = 193, Discount = 10, CreatedAt = Convert.ToDateTime("2022-08-09T23:49:58+02:00") },
               new TourDetail() { Id = "TOURDT_3", Status = 1, TourId = "TOUR_3", DepartureDay = Convert.ToDateTime("2022-08-09T23:49:58+02:00"), AvailableSeat = 25, Price = 266, Discount = 10, CreatedAt = Convert.ToDateTime("2022-08-09T23:49:58+02:00") },
               new TourDetail() { Id = "TOURDT_4", Status = 1, TourId = "TOUR_4", DepartureDay = Convert.ToDateTime("2022-08-09T23:49:58+02:00"), AvailableSeat = 25, Price = 3525, Discount = 10, CreatedAt = Convert.ToDateTime("2022-08-09T23:49:58+02:00") },
               new TourDetail() { Id = "TOURDT_5", Status = 1,TourId = "TOUR_5", DepartureDay = Convert.ToDateTime("2022-08-09T23:49:58+02:00"), AvailableSeat = 25, Price = 270, Discount = 10, CreatedAt = Convert.ToDateTime("2022-08-09T23:49:58+02:00") },
